...
('Transportation Tax', 'Fixed tax applied to transportation costs', 'fixed', 5.00, 'transportation'),
('Platform Service Fee', 'Percentage charged for platform services', 'percentage', 1.5, 'platform_fee');